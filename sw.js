const CACHE='voicerdr2-v1';
const CORE=['./','./index.html','./styles.css','./src/main.js','./src/core.js','./src/audio.js','./src/catalog.js','./src/export.js','./src/ui.js','./manifest.webmanifest','./assets/icon.svg'];
